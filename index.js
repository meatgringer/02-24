...
const quickPhrases = {
    ...
    'вокзал': { en: 'train station', de: 'bahnhof', fr: ''},
    'как дела': { en: 'how are you', de: 'wie geht es dir', fr: ''},
    'добраться': { en: 'get to the', de: 'gelangen', fr: ''},
    'попасть': { en: 'get to the', de: 'gelangen', fr: ''},
};
